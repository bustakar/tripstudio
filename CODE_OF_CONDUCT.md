...
edit, or reject contributions, comments, commits, code, and other contributions that do not align
with this Code of Conduct.

## Scope

This Code of Conduct applies within project spaces and when an individual officially represents
the project in public spaces.

## Enforcement

Report abusive, harassing, or otherwise unacceptable behavior using GitHub's private reporting and
moderation tools. Maintainers will review reports promptly and fairly, respect reporters' privacy,
